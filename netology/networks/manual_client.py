...
sock = socket.create_connection(("127.0.0.1", 10002), timeout=500)  # таймаут на установку соединения
sock.settimeout(200)  # таймаут на работу с сокетом
# не вызовет accept
with sock:
    while True:
        data_for_sending = input("Enter data for sending: ").encode("UTF-8")
